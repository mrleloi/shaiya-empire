...
class SettingDonateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = SettingDonate::query()->select(sprintf('%s.*', (new SettingDonate)->table));
            ...
            $table->editColumn('actions', function ($row) {
                $viewGate      = 'setting_donate_show';
                $editGate      = 'setting_donate_edit';
                $deleteGate    = 'setting_donate_delete';
                $crudRoutePart = 'setting-donates';
        ...
        return view('admin.settingDonates.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.settingDonates.create');
    }
    ...
    public function store(StoreSettingDonateRequest $request)
    {
        ...
        return redirect()->route('admin.setting-donates.index');
    }
    ...
    public function edit(SettingDonate $settingDonate)
    {
        ...
        return view('admin.settingDonates.edit', compact('settingDonate'));
    }
    ...
    public function show(SettingDonate $settingDonate)
    {
        ...
        return view('admin.settingDonates.show', compact('settingDonate'));
    }

        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.setting-homes.store") }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="events_title" id="events_title" value="{{ old('events_title', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="events_content" id="events_content">{!! old('events_content') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="announcement_title" id="announcement_title" value="{{ old('announcement_title', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="announcement_content" id="announcement_content">{!! old('announcement_content') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="content_server_info" id="content_server_info">{!! old('content_server_info') !!}</textarea>

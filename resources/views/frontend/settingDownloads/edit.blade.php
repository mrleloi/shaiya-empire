        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.setting-downloads.update", [$settingDownload->id]) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label for="title">{{ trans('cruds.settingDownload.fields.title') }}</label>
                                <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $settingDownload->title) }}">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="header" id="header" value="{{ old('header', $settingDownload->header) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $settingDownload->content) !!}</textarea>
                            ...
                            return loader.file
                                .then(function (file) {
                                    return new Promise(function(resolve, reject) {
                                        ...
                                        xhr.open('POST', '{{ route('frontend.setting-downloads.storeCKEditorImages') }}', true);

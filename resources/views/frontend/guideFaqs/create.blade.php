        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.guide-faqs.store") }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="question_general_content" id="question_general_content">{!! old('question_general_content') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="question_technical_content" id="question_technical_content">{!! old('question_technical_content') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="question_game_content" id="question_game_content">{!! old('question_game_content') !!}</textarea>

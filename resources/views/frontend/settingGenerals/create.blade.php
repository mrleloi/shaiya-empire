        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.setting-generals.store") }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="url_facebook" id="url_facebook" value="{{ old('url_facebook', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="url_discord" id="url_discord" value="{{ old('url_discord', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="meta_keyword" id="meta_keyword" value="{{ old('meta_keyword', '') }}">

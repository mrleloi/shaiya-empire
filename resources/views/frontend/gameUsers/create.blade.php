        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.game-users.store") }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="form-group">
                                <label for="useruid">{{ trans('cruds.gameUser.fields.useruid') }}</label>
                                <input class="form-control" type="number" name="useruid" id="useruid" value="{{ old('useruid', '') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="joindate" id="joindate" value="{{ old('joindate') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="admin" id="admin" value="{{ old('admin', '0') }}" step="1">
                                @if($errors->has('admin'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('admin') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="adminlevel" id="adminlevel" value="{{ old('adminlevel', '0') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="usequeue" id="usequeue" value="{{ old('usequeue', '0') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="leave" id="leave" value="{{ old('leave', '') }}" step="1">
                                @if($errors->has('leave'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('leave') }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="leavedate" id="leavedate" value="{{ old('leavedate') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="usertype" id="usertype" value="{{ old('usertype', '\'U\'') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="userip" id="userip" value="{{ old('userip', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="modiip" id="modiip" value="{{ old('modiip', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control datetime" type="text" name="modidate" id="modidate" value="{{ old('modidate') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="enpassword" id="enpassword" value="{{ old('enpassword', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="birth" id="birth" value="{{ old('birth', '') }}">
                                @if($errors->has('birth'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('birth') }}
                                    </div>

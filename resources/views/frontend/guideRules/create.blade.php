        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.guide-rules.store") }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="play_nice_policies_title" id="play_nice_policies_title" value="{{ old('play_nice_policies_title', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="play_nice_policies_content" id="play_nice_policies_content">{!! old('play_nice_policies_content') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="tos_title" id="tos_title" value="{{ old('tos_title', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="tos_content" id="tos_content">{!! old('tos_content') !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="agreement_title" id="agreement_title" value="{{ old('agreement_title', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="agreement_content" id="agreement_content">{!! old('agreement_content') !!}</textarea>

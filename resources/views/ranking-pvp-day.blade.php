...
<script type="text/javascript">
    $('#form_ranking_chiencichngay').submit(function () {
        var selectedDate = $('#form_ranking_chiencichngay input[name="SelectDay"]').val();
        var formattedDate = selectedDate.split('-').reverse().join('-');
        $('#form_ranking_chiencichngay').append('<input type="hidden" name="date" value="' + formattedDate + '">');
                        ...
                        <table id="rank" class="rank">
                            ...
                            @forelse($aolRanks as $index => $player)
                                <tr>
                                    ...
                                    <td style="text-align: center;font-size:13px;">{{ \App\Helpers\Helper::getKillCount($player) }}</td>
                                </tr>
                            @empty
                                <tr>

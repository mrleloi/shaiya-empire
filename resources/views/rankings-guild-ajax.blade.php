@if(isset($listType1) && count($listType1) > 0)
        ...
        <table id="rank" class="rank">
            ...
            @foreach($listType1 as $item)
                <tr>
                    ...
                    <td style="text-align: center;font-size:13px;">{{ $item->Kills }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
    ...
    <div class="pagination" style="text-align: center; margin-top: 20px;">
        <a class="nice_button guild-paginate" data-page="1" href="javascript:void(0)"><i class="fas fa-angle-double-left" aria-hidden="true"></i></a>
        @php
            ...
            for ($i = $start; $i <= $end; $i++) {
                echo '<a style="margin-left:5px;" class="nice_button guild-paginate '.($i == $listType1->currentPage() ? 'nice_active' : '').'" data-page="'.$i.'" href="javascript:void(0)">'.$i.'</a>';
            }
        ...
        @endphp
        <a style="margin-left:5px;" class="nice_button guild-paginate" data-page="{{ $listType1->lastPage() }}" href="javascript:void(0)"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a>
    </div>
@else

        ...
        <div class="main_content">
            <div class="form-holder register">
                <form action="" method="post" name="password_change" id="password_change">
                    <label class="styled-row" for="old_password"><p>Mật khẩu cũ</p><input type="password" maxlength="32" value="" name="old_password" id="old_password" required></label>
                    <label class="styled-row" for="new_password"><p>Mật khẩu mới</p><input type="password" maxlength="64" value="" name="new_password" id="new_password" required></label>
                    <label class="styled-row" for="new_password_confirmation"><p>Lặp lại Mật khẩu mới</p><input type="password" maxlength="64" value="" name="new_password_confirmation" id="new_password_confirmation" required></label>
...
<script type="text/javascript">
    ...
    $('#password_change').submit(function () {
        loadUpForm('#password_change_result', './pages/do-change-password1.php', '#password_change' );
        return false;
    });
</script>

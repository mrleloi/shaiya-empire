...
@section('content')
    @can('setting_donate_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.setting-donates.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SettingDonate">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.setting-donates.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.setting-donates.index') }}",
                    columns: [
            ...
            let table = $('.datatable-SettingDonate').DataTable(dtOverrideGlobals);

...
@section('content')
    @can('guide_rule_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.guide-rules.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-GuideRule">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.guide-rules.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.guide-rules.index') }}",
                    columns: [
                        { data: 'placeholder', name: 'placeholder' },
                        { data: 'id', name: 'id' },
                        { data: 'title', name: 'title' },
                        { data: 'header', name: 'header' },
                        { data: 'play_nice_policies_title', name: 'play_nice_policies_title' },
                        /*{ data: 'tos_title', name: 'tos_title' },
                        { data: 'agreement_title', name: 'agreement_title' },*/
            ...
            let table = $('.datatable-GuideRule').DataTable(dtOverrideGlobals);

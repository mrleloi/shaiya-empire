...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.guide-rules.update", [$guideRule->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="title">{{ trans('cruds.guideRule.fields.title') }}</label>
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $guideRule->title) }}">
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('header') ? 'is-invalid' : '' }}" type="text" name="header" id="header" value="{{ old('header', $guideRule->header) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('play_nice_policies_title') ? 'is-invalid' : '' }}" type="text" name="play_nice_policies_title" id="play_nice_policies_title" value="{{ old('play_nice_policies_title', $guideRule->play_nice_policies_title) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('play_nice_policies_content') ? 'is-invalid' : '' }}" name="play_nice_policies_content" id="play_nice_policies_content">{!! old('play_nice_policies_content', $guideRule->play_nice_policies_content) !!}</textarea>
                ...
                {{--<div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tos_title') ? 'is-invalid' : '' }}" type="text" name="tos_title" id="tos_title" value="{{ old('tos_title', $guideRule->tos_title) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('tos_content') ? 'is-invalid' : '' }}" name="tos_content" id="tos_content">{!! old('tos_content', $guideRule->tos_content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('agreement_title') ? 'is-invalid' : '' }}" type="text" name="agreement_title" id="agreement_title" value="{{ old('agreement_title', $guideRule->agreement_title) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('agreement_content') ? 'is-invalid' : '' }}" name="agreement_content" id="agreement_content">{!! old('agreement_content', $guideRule->agreement_content) !!}</textarea>

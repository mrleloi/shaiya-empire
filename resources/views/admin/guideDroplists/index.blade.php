...
@section('content')
    @can('guide_droplist_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.guide-droplists.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-GuideDroplist">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.guide-droplists.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.guide-droplists.index') }}",
                    columns: [
            ...
            let table = $('.datatable-GuideDroplist').DataTable(dtOverrideGlobals);

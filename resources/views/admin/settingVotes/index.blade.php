...
@section('content')
    @can('setting_vote_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.setting-votes.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SettingVote">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.setting-votes.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.setting-votes.index') }}",
                    columns: [
            ...
            let table = $('.datatable-SettingVote').DataTable(dtOverrideGlobals);

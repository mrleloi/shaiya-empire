...
@section('content')
    @can('setting_item_mall_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.setting-item-malls.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SettingItemMall">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.setting-item-malls.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.setting-item-malls.index') }}",
                    columns: [
            ...
            let table = $('.datatable-SettingItemMall').DataTable(dtOverrideGlobals);

...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.settingBossRecord.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.setting-boss-records.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label for="content">{{ trans('cruds.settingBossRecord.fields.content') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.settingBossRecord.fields.content_helper') }}</span>
                </div>
                <div class="form-group">

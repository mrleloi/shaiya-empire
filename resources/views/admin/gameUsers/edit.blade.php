...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.game-users.update", [$gameUser->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="useruid">{{ trans('cruds.gameUser.fields.useruid') }}</label>
                    <input class="form-control {{ $errors->has('useruid') ? 'is-invalid' : '' }}" type="number" name="useruid" id="useruid" value="{{ old('useruid', $gameUser->UserUID) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('userid') ? 'is-invalid' : '' }}" type="text" name="userid" id="userid" value="{{ old('userid', $gameUser->userid) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('joindate') ? 'is-invalid' : '' }}" type="text" name="joindate" id="joindate" value="{{ old('joindate', $gameUser->joindate) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('admin') ? 'is-invalid' : '' }}" type="number" name="admin" id="admin" value="{{ old('admin', $gameUser->admin) }}" step="1">
                    @if($errors->has('admin'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('adminlevel') ? 'is-invalid' : '' }}" type="number" name="adminlevel" id="adminlevel" value="{{ old('adminlevel', $gameUser->adminlevel) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('usequeue') ? 'is-invalid' : '' }}" type="number" name="usequeue" id="usequeue" value="{{ old('usequeue', $gameUser->usequeue) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $gameUser->status) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('leave') ? 'is-invalid' : '' }}" type="number" name="leave" id="leave" value="{{ old('leave', $gameUser->leave) }}" step="1">
                    @if($errors->has('leave'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('leavedate') ? 'is-invalid' : '' }}" type="text" name="leavedate" id="leavedate" value="{{ old('leavedate', $gameUser->leavedate) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('usertype') ? 'is-invalid' : '' }}" type="text" name="usertype" id="usertype" value="{{ old('usertype', $gameUser->usertype) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('userip') ? 'is-invalid' : '' }}" type="text" name="userip" id="userip" value="{{ old('userip', $gameUser->userip) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('modiip') ? 'is-invalid' : '' }}" type="text" name="modiip" id="modiip" value="{{ old('modiip', $gameUser->modiip) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('modidate') ? 'is-invalid' : '' }}" type="text" name="modidate" id="modidate" value="{{ old('modidate', $gameUser->modidate) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('point') ? 'is-invalid' : '' }}" type="number" name="point" id="point" value="{{ old('point', $gameUser->point) }}" step="1">
                    @if($errors->has('point'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('enpassword') ? 'is-invalid' : '' }}" type="text" name="enpassword" id="enpassword" value="{{ old('enpassword', $gameUser->enpassword) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('birth') ? 'is-invalid' : '' }}" type="text" name="birth" id="birth" value="{{ old('birth', $gameUser->birth) }}">
                    @if($errors->has('birth'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $gameUser->email) }}">
                    @if($errors->has('email'))

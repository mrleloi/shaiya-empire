...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.setting-homes.update", [$settingHome->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $settingHome->title) }}">
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('header') ? 'is-invalid' : '' }}" type="text" name="header" id="header" value="{{ old('header', $settingHome->header) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('events_title') ? 'is-invalid' : '' }}" type="text" name="events_title" id="events_title" value="{{ old('events_title', $settingHome->events_title) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('content_server_info') ? 'is-invalid' : '' }}" name="content_server_info" id="content_server_info">{!! old('content_server_info', $settingHome->content_server_info) !!}</textarea>
                ...
                {{--<div class="form-group">
                    <label for="server_information_full">{{ trans('cruds.settingHome.fields.server_information_full') }}</label>
                    <textarea class="form-control ckeditor {{ $errors->has('server_information_full') ? 'is-invalid' : '' }}" name="server_information_full" id="server_information_full">{!! old('server_information_full', $settingHome->server_information_full) !!}</textarea>
                ...
                {{--<div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('events_content') ? 'is-invalid' : '' }}" name="events_content" id="events_content">{!! old('events_content', $settingHome->events_content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('announcement_title') ? 'is-invalid' : '' }}" type="text" name="announcement_title" id="announcement_title" value="{{ old('announcement_title', $settingHome->announcement_title) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('announcement_content') ? 'is-invalid' : '' }}" name="announcement_content" id="announcement_content">{!! old('announcement_content', $settingHome->announcement_content) !!}</textarea>
        ...
        Dropzone.options.slideImagesDropzone = {
            ...
            init: function () {
                ...
                var files = {!! json_encode($settingHome->slide_images) !!}
                    ...
                    var file = files[i]
                    this.options.addedfile.call(this, file)
                    var preview_url = file.preview_url === '' ? file.original_url : file.preview_url
                    this.options.thumbnail.call(this, file, file.preview ?? preview_url)
                    file.previewElement.classList.add('dz-complete')

        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.setting-generals.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url_facebook') ? 'is-invalid' : '' }}" type="text" name="url_facebook" id="url_facebook" value="{{ old('url_facebook', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url_discord') ? 'is-invalid' : '' }}" type="text" name="url_discord" id="url_discord" value="{{ old('url_discord', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('video_thumbnail') ? 'is-invalid' : '' }}" type="text" name="video_thumbnail" id="video_thumbnail" value="{{ old('video_thumbnail', '') }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table" id="carousel-videos-table">
                            ...
                            <tbody>
                            @php
                                $carouselVideos = old('carousel_videos', []);
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            let videoCounter = {{ count(old('carousel_videos', [])) ?: 0 }};

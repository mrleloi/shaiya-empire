...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.guide-faqs.update", [$guideFaq->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="title">{{ trans('cruds.guideFaq.fields.title') }}</label>
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $guideFaq->title) }}">
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('header') ? 'is-invalid' : '' }}" type="text" name="header" id="header" value="{{ old('header', $guideFaq->header) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('question_general_content') ? 'is-invalid' : '' }}" name="question_general_content" id="question_general_content">{!! old('question_general_content', $guideFaq->question_general_content) !!}</textarea>
                ...
                {{--<div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('question_technical_content') ? 'is-invalid' : '' }}" name="question_technical_content" id="question_technical_content">{!! old('question_technical_content', $guideFaq->question_technical_content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('question_game_content') ? 'is-invalid' : '' }}" name="question_game_content" id="question_game_content">{!! old('question_game_content', $guideFaq->question_game_content) !!}</textarea>
